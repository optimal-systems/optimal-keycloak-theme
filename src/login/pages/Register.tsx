...
export default function Register(props: PageProps<Extract<KcContext, { pageId: "register.ftl" }>, I18n>) {
    ...
    const passwordMatchColor = formData.confirmPassword ? (formData.password === formData.confirmPassword ? "green.500" : "red.500") : "gray.300";
                ...
                >
                    ...
                    <Stack spacing={2} textAlign="center" w="full">
                        ...
                        <Text fontSize="sm" color="gray.500">
                            Join Optimal and start saving today
                        </Text>
                    </Stack>
                    ...
                    >
                        ...
                        <Stack spacing={4} w="full">
                            ...
                            <FormControl isInvalid={isSubmitted && (!formData.confirmPassword || formData.password !== formData.confirmPassword)}>
                                ...
                                {formData.confirmPassword && (
                                    <Text fontSize="xs" color={passwordMatchColor} mt={1} display="flex" alignItems="center">
